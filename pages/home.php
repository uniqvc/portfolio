	...
	<section class="section-default section-equipe container-padding">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-md-4 col-lg-3 equipe-item">
				...
				<p class="text-large">
					Formado em Análise de sistemas, 10 anos de experiência com programação, apaixonado pelo impacto que a tecnologia pode trazer aos negócios, de raiz nordestina, busco satisfação nas pequenas coisas e na vida simples.
				</p>
			</div>
		</div>
	</section>
